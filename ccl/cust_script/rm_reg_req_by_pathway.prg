...
******************************************************************************
  ...
  Solution:           
  Source file name:   rm_reg_req_by_pathway.prg
  Object name:        rm_reg_req_by_pathway
  Request #:
...
******************************************************************************/
drop program rm_reg_req_by_pathway:dba go
create program rm_reg_req_by_pathway:dba
...
from
	pathway p
plan p
	where p.pathway_id = $PATHWAY_ID
detail
	t_rec->patient.encntr_id 				= p.encntr_id
